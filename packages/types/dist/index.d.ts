...
export type AppMode = "dating" | "hook" | "co_travel" | "night_out" | "club_mates" | "happening";
...
export type ReportReason = "harassment" | "fake-profile" | "inappropriate-content" | "spam" | "underage" | "other";
...
export type SocketClientEvent = "user:online" | "location:update" | "nearby:subscribe" | "message:send" | "typing:start" | "typing:stop" | "call:request" | "call:accept" | "call:reject" | "call:end" | "webrtc:offer" | "webrtc:answer" | "webrtc:ice";
export type SocketServerEvent = "nearby:update" | "ping:received" | "message:new" | "typing:update" | "call:incoming" | "call:accepted" | "call:rejected" | "call:ended" | "match:new";
